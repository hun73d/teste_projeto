...
public class Review implements Serializable {
     ...
     *            Times tasted
     */
    public Review(int score, String name,String anunciante, LocalDate date, Categoria category,
            int count) {
        this.score = score;
        this.nome = name;
        this.date = date;
        this.category = new Categoria(category);
        this.count = count;
     ...
     */
    public Review(Review other) {   //Construtor 
        this(other.getScore(), other.getName(), other.getAnunciante(), other.getDate(),
     ...
     */
    public void reset() {  //método para resetar os atributos para valores-padrão;
        this.id = null;
        this.score = 1;
        this.nome = "";
    ...
    public String toString() {
        ...
        return "Review{" + "id=" + getId() + ", score=" + getScore() + ", name="
                ...
                + getDate() + ", count=" + getCount() + ", anunciante=  "+getAnunciante()+'}';
    }
